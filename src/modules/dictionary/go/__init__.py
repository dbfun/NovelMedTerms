...
class Go(UmlsMetathesaurus):
    """
    Вспомогательный класс для работы с GO - Gene Ontology.
    """
...
class DictionaryGo(UmlsDictionaryModule):
    """
    Модуль поиска термина в словаре GO.
    """

    @staticmethod
    def info() -> ModuleInfo:
        return ModuleInfo(module="dictionary", type="GO")
